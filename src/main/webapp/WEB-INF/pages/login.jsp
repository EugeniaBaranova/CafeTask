            ...
            <div class="login_form">
                ...
                <form action="/controller" method="post">
                    ...
                    <div class="container">
                        ...
                        <input class="form-control" type="password" placeholder="<fmt:message key="login.placeholder.password"/>" id="psw" name="password" required>

                        <button class="login_btn" type="submit"><fmt:message key="login.button.submit"/></button>
                    </div>
                </form>
                <hr>
                <form action="/registration" method="post">
                        <button class="login_btn" type="submit"><fmt:message key="login.button.singup"/></button>
                </form>
            </div>
    </body>
</html>